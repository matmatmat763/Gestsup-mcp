...
const STOPWORDS = new Set([
  "les", "des", "une", "uns", " une", "que", "qui", "quoi", "dont", "avec", "sans",
  "pour", "par", "sur", "sous", "dans", "est", "sont", "été", "être", "avoir",
  "cette", "ces", "son", "ses", "leur", "leurs", "nous", "vous", "ils", "elle",
  "elles", "mais", "donc", "car", "plus", "moins", "très", "pas", "ne", "le", "la",
  "un", "de", "du", "au", "aux", "et", "ou", "à", "en", "ce", "se", "il", "on",
  "the", "and", "for", "with", "from", "this", "that", "ticket", "gestsup",
]);
...
export function findSimilarNotes(
  ...
  const duplicate = scored.find(
    (n) =>
      n.sameTicket ||
      (n.relevance >= relTh && resTokens.size > 0 && n.resolutionOverlap >= resTh),
  );
